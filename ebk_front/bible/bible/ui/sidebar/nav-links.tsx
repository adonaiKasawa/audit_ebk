...
const links = [
  { name: "Accueil", href: "https://ecclesiabook.org", icon: HomeIcon, menu: false },
  {
    name: "Églises",
    href: "/list-church",
  ...
  },
  {
    ...
    menu: true,
    option: [
      { name: "Vidéos", href: "https://ecclesiabook.org/videos", icon: PlayIcon, menu: false },
      { name: "Audios", href: "https://ecclesiabook.org/audios", icon: MusicalNoteIcon, menu: false },
      { name: "Images", href: "https://ecclesiabook.org/pictures", icon: PhotoIcon, menu: false },
      {
        name: "Livres",
        href: "https://ecclesiabook.org/book",
        icon: Bars4Icon,
        menu: false,
      },
    ],
      ...
      {footer.map((link) => {
        return (
          <Link
            key={link.name}
            className={clsx(
              "text-sm font-medium text-neutral-50 hover:bg-sky-100 md:flex-none justify-start",
              {
                "bg-primary": pathname === link.href,
              },
            )}
