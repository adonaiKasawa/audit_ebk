...
function DeleteDataAccountPage({ initSession }: AccountSettingComponents) {
  ...
  const handleSubmit = async () => {
    setLoading(true);
    const update = await AuthDeleteDataOfUserApi();
    ...
    if (
      ...
      setAlertMsg(
        "La suppression de vos données a été effectuée avec succès; vos données sont définitivement supprimées et irrécupérables.",
      );
...
export default DeleteDataAccountPage;
