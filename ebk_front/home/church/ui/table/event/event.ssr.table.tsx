...
export default function EventSsrTableUI({
  initData,
  session,
}: {
  session: Session;
  ...
  const renderCell = React.useCallback(
    (event: Events, columnKey: React.Key) => {
      switch (columnKey) {
        case "name":
        ...
        case "actions":
          return (
            <ActionEvent event={event} handleFindEvent={handleFindEvent} />
          );
        default:
          return <></>;
      }
