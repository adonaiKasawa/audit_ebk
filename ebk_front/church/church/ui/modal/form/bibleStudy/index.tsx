...
export default function AddBibleStudyFormModal() {
    ...
    try {
      ...
      if (
        ...
        for (const option of optionsSelected) {
          ...
          setLoading(true);
          const res = await createContentBibleStudyApi(formData, response.id);
                ...
                <div className="flex justify-center h-full">
                  <form className="w-2/4" onSubmit={handleSubmit}>
                        ...
                        >
                          <div className="flex flex-col gap-1">
                            ...
                            <p className="text-tiny text-default-400">
                              Si votre étude biblique est payant ou gratuite !
                            </p>
                          </div>
                        </Switch>
                      </div>
                    ...
                    <div className="flex justify-between">
                      ...
                      <Button onClick={addOptionSection}>
                        Ajouter une section
                      </Button>
                    </div>
                  </form>
