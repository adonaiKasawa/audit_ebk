...
import NavLinks from "../sidebar/admin/nav-links";
  ...
  return (
    <>
      <NextUINavbar maxWidth="xl" position="sticky">
                ...
                <div className="flex justify-between items-center space-x-2">
                  {session.user.privilege_user ===
                    PrivilegesEnum.ADMIN_EGLISE && (
                      <Button
                        as={Link}
                        href="/church" // ou la page de gestion que tu veux
                        size="sm"
                        variant="bordered"
                        className="text-foreground py-5"
                      >
        ...
        <NavbarContent className="sm:flex pl-4" justify="end">
          <NavbarMenuToggle />
        </NavbarContent>
