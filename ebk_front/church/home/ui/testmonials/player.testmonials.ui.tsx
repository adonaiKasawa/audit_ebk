...
import TestimonialActions from "@/app/(overview)/testimonials/actions.testimonials";
...
>
  ...
  <div className="absolute bottom-0 left-0 right-0 flex justify-center z-10 p-2 gap-2">
    <TestimonialActions
      testimonialId={testmonial.id}
      initialLiked={testmonial.isLiked}
      initialLikes={testmonial.likesCount}
      initialFavorited={testmonial.isFavorited}
      initialFavorites={testmonial.favoritesCount}
      session={session}
